...
class _SwpCalculatorViewState extends State<SwpCalculatorView> {
  ...
  final _swpCalcFormKey = GlobalKey<FormState>();
                  ...
                  children: [
                    ...
                    Flexible(
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          if (_swpCalcFormKey.currentState?.validate() ?? false) {
                            setState(() {
                              isLoading = true;
                            });
                  ...
                  isLoading == true
                      ...
                      : _swpCalculatorController.obx((state) {
                          List<KeyValuePairModel> keyValueList = [
                            KeyValuePairModel(
                              key: "Final Amount: ",
                              value: format2INR((state?.withdrawnAmount ?? 0) +
                                  (state?.reports.yearlyReport.last.value ?? 0)),
                              extra: " (${state?.gainLossPer.toStringAsFixed(2)}%)",
                            ),
                            KeyValuePairModel(
                              key: "Invested Amount",
                              value: format2INR(state?.corpusAmount),
                            ),
                            KeyValuePairModel(
                              key: "Est. Returns",
                              value: format2INR(state?.interestEarned),
                            ),
                            KeyValuePairModel(
