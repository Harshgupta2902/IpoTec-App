...
class LumpsumCalculatorView extends StatefulWidget {
  const LumpsumCalculatorView({super.key});

  @override
  State<LumpsumCalculatorView> createState() => _LumpsumCalculatorViewState();
}

class _LumpsumCalculatorViewState extends State<LumpsumCalculatorView> {
