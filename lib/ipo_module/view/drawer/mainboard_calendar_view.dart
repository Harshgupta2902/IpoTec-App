...
import 'package:ipotec/ipo_module/controller/drawer/mainboard_calendar_controller.dart';
...
class MainboardCalendarView extends StatefulWidget {
  ...
  @override
  MainboardCalendarViewState createState() => MainboardCalendarViewState();
}
...
class MainboardCalendarViewState extends State<MainboardCalendarView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _mainboardCalendarController.obx((state) {
        return Column(
            ...
            SizedBox(
              child: Column(
                ...
                children: [
                  ...
                  _mainboardCalendarController.obx((state) {
                    return Padding(
